...
[`@aws-sdk/client-kms`](https://www.npmjs.com/package/@aws-sdk/client-kms/v/3.908.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kms@3.908.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-N3ND95QMJNxE5b+wK8VkyOB74b48S/APZmKISwaiVT5m9pTHKey6tUaLFO000f0b
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kms": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kms@3.908.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kms@3.908.0/index.min.mjs": "sha384-N3ND95QMJNxE5b+wK8VkyOB74b48S/APZmKISwaiVT5m9pTHKey6tUaLFO000f0b"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kms/blob/refs/tags/3.908.0/LICENSE
```
